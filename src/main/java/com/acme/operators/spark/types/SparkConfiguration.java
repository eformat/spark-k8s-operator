...
public class SparkConfiguration {
    ...
    public String toString() {
        ...
        sb.append(SparkConfiguration.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SparkConfiguration) == false) {
            return false;
        }
        SparkConfiguration rhs = ((SparkConfiguration) other);
